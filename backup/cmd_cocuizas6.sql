...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-08-2015 a las 23:41:32
...
CREATE TABLE IF NOT EXISTS `aplicacion_terapia` (
  ...
  `fecha` date NOT NULL,
  `descrip_aplic` varchar(255) NOT NULL,
  `terapista` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `cod_orden_terapia` (`orden_id`),
  KEY `descrip_aplic` (`descrip_aplic`)
...
INSERT INTO `aplicacion_terapia` (`id`, `orden_id`, `fecha`, `descrip_aplic`, `terapista`) VALUES
(1, 12, '2015-08-26', 'pediluvio', 'karen'),
(2, 12, '2015-08-26', 'bbbbbbbbbbbbbbbbbbbbbbbbb bbbbbb', 'hhhhh'),
(3, 12, '2015-08-26', 'xxxxxxxxxxxxxxxxxxxx', ''),
(4, 12, '2015-08-26', '', ''),
(5, 12, '2015-08-26', '', ''),
(6, 12, '2015-08-26', '', ''),
(7, 12, '2015-08-26', 'xxxxxxxxxxxxxxxxxxxxxxx', ''),
(8, 12, '2015-08-26', '', ''),
(9, 12, '2015-08-26', '', ''),
(10, 12, '2015-08-26', '', ''),
(11, 12, '2015-08-26', 'xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx', ''),
(12, 12, '2015-08-26', 'qqqqqqqqqqqqqqqqqqqq', ''),
(13, 12, '2015-08-26', 'sssssssssssss', ''),
(14, 12, '2015-08-26', 'xxxxxxxxxxxxxxx', ''),
(15, 12, '2015-08-26', '', ''),
(16, 12, '2015-08-26', '', ''),
(17, 12, '2015-08-26', '', ''),
(18, 12, '2015-08-26', '', '');
...
CREATE TABLE IF NOT EXISTS `examenes` (
  `cod_exam` int(11) NOT NULL AUTO_INCREMENT,
  `exp_med` int(11) NOT NULL,
  `fecha_exam` date DEFAULT NULL,
  `tipo_exam` varchar(1000) DEFAULT NULL,
  `obs_exam` text,
  PRIMARY KEY (`cod_exam`),
  KEY `cod_exp_med` (`exp_med`)
...
INSERT INTO `examenes` (`cod_exam`, `exp_med`, `fecha_exam`, `tipo_exam`, `obs_exam`) VALUES
(1, 14, '2014-10-22', 'q', 'q'),
(2, 14, '2014-10-23', 's', 's'),
(3, 14, '2014-10-23', 'e', 'e'),
(4, 14, '2014-10-23', 'ASDF', 'ASDF'),
(5, 14, '2014-10-24', 'holaaa', 'ccc'),
(6, 16, '2014-10-28', 'lolojhh', 'ffff'),
(7, 16, '2014-10-31', 'vvvv', 'ddd'),
(8, 16, '2014-11-16', 'dfsd', 'gfgas'),
(9, 16, NULL, '1', '1'),
(10, 1, '2014-01-22', 'Frotis', NULL);
...
(10, 1, 16, '2015-08-22', '   xx ', '3/semana', 2, 'Bioxigenación,Ultravitamina C,Terapia neural,Camilla de jade,Cardocirculatorio,Triple Cura', '{"Bioxigenaci\\u00f3n":"4","Ultravitamina C":"1","Terapia neural":"5","Camilla de jade":"2","Cardocirculatorio":"6","Triple Cura":"3"}'),
(11, 1, NULL, '2015-08-25', 'xx', '2/semana', 1, 'Quelación,Electroestimulación magnetica,Inmunoforte', '{"Quelaci\\u00f3n":"2","Electroestimulaci\\u00f3n magnetica":"4","Inmunoforte":"6"}'),
(12, 1, NULL, '2015-08-25', '', '1/semana', 2, 'Bioxigenación', '{"Bioxigenaci\\u00f3n":"2"}');
...
CREATE TABLE IF NOT EXISTS `procedimientos` (
  `cod_proced` int(11) NOT NULL AUTO_INCREMENT,
  `cod_exp_med` int(11) NOT NULL,
  `descrip_proced` text,
  `fecha_proced` date DEFAULT NULL,
  `obs_proced` text,
  PRIMARY KEY (`cod_proced`),
  KEY `cod_exp_med` (`cod_exp_med`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
