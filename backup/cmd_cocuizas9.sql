...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-09-2015 a las 15:52:33
...
(1, 'cmd_admin', '$2a$08$jVaQmhCF9MRqwSc57EkN6u2Vi1B8mO9dUiAASHe66VUpIAOA5/dSq', 'Administrador', NULL, 'F', 1, '$2a$08$YKDL7SaZOO3paeef50jVxudn6W5aSbX.wZBVEKiexjFchu0/nBXd.', 'admin@cocuizas.com', 1, 1, '2015-07-01');
...
ALTER TABLE `historia_medica`
  ADD CONSTRAINT `historia_medica_ibfk_1` FOREIGN KEY (`expediente_id`) REFERENCES `expediente_medico` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
