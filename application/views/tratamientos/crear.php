          ...
          <div class='row'>
              ...
              <div class="box box-success">
                <div class="box-header">
                  <h3 class="box-title">Terapia</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                 <form method="post" id="form_terapia" action="<?php echo base_url(); ?>terapias/guardar_terapia">  
				 
                  <div class="box-body">
                    <div class="form-group">
                      <input type="text" class="form-control" name="descripcion" placeholder="Nombre de la terapia">
                    </div>
					<div class="form-group">
                      <select class="form-control" name="tipo" required>
								  <option value="">Seleccione el tipo de terapia</option>
								  <option value="1">Sueros básicos</option>
								  <option value="2">Sueros Expecíficos</option>
								  <option value="3">Terapias Complemetarias</option>
					 </select>
                    </div>
                  </div><!-- /.box-body -->
