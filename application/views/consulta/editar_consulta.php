...
<form method="post" name="datos_consulta" action="<?= base_url(); ?>consulta/actualizar_consulta/<?= $cita ?>">	 
             ...
             <br>   			
					<div class="row">				   
						<div class="form-group col-xs-2">
						  ...
						  <input type="text" class="form-control" name="tension_arteria" value=" <?=  $row['tension_arteria']; ?>">
						</div>
						<div class="form-group col-xs-2">
						  <label>Peso (Kg)</label>
						...
						<div class="form-group col-xs-2">
						  ...
						  <input type="text" class="form-control" name="pulso" value=" <?=  $row['pulso']; ?>" >
						</div>
						<div class="form-group col-xs-2">
						  <label>Respiraciones (rpm)</label>
						  <input type="text" class="form-control" name="resp" value=" <?=  $row['resp']; ?>">
						</div>
					</div>
			</div>	
             ...
             <br>     		
					...
					<div class="row">				   
						<div class="form-group col-xs-6">
						 ...
						 <textarea name="motivo_consul" class="form-control"> <?= $row['motivo_consul']; ?> </textarea>
						</div>
						<div class="form-group col-xs-6">
						  <label>Enfermedad actual</label>
						   <textarea name="enfermedad_actual" class="form-control"><?= $row['enfermedad_actual']; ?> </textarea>
						</div>
					</div>	
			</div>
             ...
             <br>     		
					<div class="row">				   
						<div class="form-group col-xs-6">
						 ...
						 <textarea name="diagnostico" class="form-control"><?=  $row['diagnostico']; ?></textarea>
						</div>
						<div class="form-group col-xs-6">
					...
					<div class="row">
						<div class="form-group col-xs-6">
						  <label>Observaciones</label>
						   <textarea name="observacion_consul" class="form-control"> <?=  $row['observacion_consul']; ?></textarea>
						</div>									 
					</div>	
			</div>	
