	...
	<?php $this->load->view('layouts/menu.php');	 ?>	
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
           Procedimientos <small>- Registrar</small>
          </h1>
        </section>
		...
		<div class="col-md-7">
              ...
              <div class="box box-warning">
                <div class="box-body">
                  ...
                  <form method="post" name="form_procedimiento" id="form_procedimiento" action="<?php echo base_url(); ?>procedimientos/guardar">  
					...
					<div class="form-group">
						...
						<div class="row">				 
						<div class="col-xs-8">
						  <input type="text" name="descrip" id="tipo" required class="form-control" value="">
						</div> 
						</div>
					</div> 
					<div class="form-group">
						...
						<div class="row">				 
						<div class="col-xs-8">
						  <textarea name="obs_proced" class="form-control"></textarea>
						</div> 
						</div>
					</div>					
				</div><!-- /.box-body -->
