					  ...
					  <?php if(is_array($pacientes) && count($pacientes) ){
						...
						foreach($pacientes as $row){ ?>
						  ...
						  <td>
							...
							<i class="fa fa-info-circle" title="ver datos" style="cursor:pointer" onclick="ficha_paciente(<?= $row['id'];?>)"></i>
							&nbsp;
							...
							<i title="Editar" style="cursor:pointer" class="fa fa-edit" onclick="location.href='<?= base_url(); ?>pacientes/editar/<?= $row['id'];?>'"></i>
							&nbsp;
							<?php	
								}else{
							?>
							
							<i class="fa fa-edit" onclick="editar_permiso()"></i>
							&nbsp;
							<?php	
								}
							?>			
							...
							<i title="Eliminar" style="cursor:pointer" class="fa fa-trash-o" onclick="eliminar(<?= $row['id'];?>, '<?= base_url(); ?>pacientes/eliminar')"></i>
