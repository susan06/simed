	...
	<?php $this->load->view('layouts/menu.php');	 ?>	
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
         Búsqueda de expediente médico<small></small>
          </h1>
        </section>
          ...
          <div class='row'>
            <div class='col-md-12'>
			  <div class="box">
				...
				<button type="button" class="btn btn-success" onclick="expediente_paciente( $('#expediente_id').val())">Buscar</button>
				</div>
              ...
              <div class="modal-dialog"  role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <p>Debe seleccionar una paciente registrado en el sistema</p>
                  </div>
   ...
   <!-- jQuery -->
	...
	$(document).ready(function () {	
		...
		function expediente_paciente(expediente){ 
		
			if(expediente){
				location.href="<?= base_url(); ?>expedientes/medico/"+expediente;
			}else{
